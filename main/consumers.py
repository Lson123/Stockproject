import json
from main.models import StockDetail
...
class StockConsumer(AsyncWebsocketConsumer):
    ...
    def addToCeleryBeat(self, stockpicker):
        ...
        if len(task)>0:
            ...
            task = PeriodicTask.objects.create(interval = schedule, name='every-1-seconds', task="main.tasks.update_stock", args = json.dumps([stockpicker]))
